...
public class Reportes extends JFrame {
    ...
    public Reportes(String nombre, String apellido, String rol) {
    ...
    private void editarUsuario(int fila) {
        ...
        // Rol NO EDITABLE
        JLabel lblRol = new JLabel("Rol (No editable):");
        lblRol.setFont(new Font("Segoe UI", Font.PLAIN, 13));
        lblRol.setBorder(BorderFactory.createEmptyBorder(10, 0, 5, 0));
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            new Reportes("Admin", "Sistema", "Administrador").setVisible(true);
        });
    }
}